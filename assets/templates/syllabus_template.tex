...
E-mail: $if(email)$\href{mailto:$email$}{\texttt{$email$}}$else$TBD$endif$ & Instructor: $if(instructor)$$instructor$$else$TBD$endif$\\
Office: $if(office)$$office$$else$TBD$endif$ & Office Hours: $if(officehours)$$officehours$$else$TBD$endif$\\
Teaching Assistant: $if(ta)$$ta$$else$TBD$endif$ & TA Email: $if(ta-email)$\href{mailto:$ta-email$}{\texttt{$ta-email$}}$else$TBD$endif$\\
TA Office: $if(ta-office)$$ta-office$$else$TBD$endif$ & TA Office Hours: $if(ta-hours)$$ta-hours$$else$TBD$endif$\\
Course Repository: \gitrepo{$github$} & Term: $if(term)$$term$$else$TBD$endif$\\
\hline
\end{tabular*}
