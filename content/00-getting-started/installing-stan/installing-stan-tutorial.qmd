...
algorithm [@Buerkner2017; @Buerkner2018; @Carpenter2017; @Hoffman2014]. After
...
install both `{rstan}` and `{StanHeaders}` [@SDT2022; @SDT2022a].
...
light-weight alternative to `{rstan}`, as a back-end instead of `{rstan}`
...
\beta_{2} &\sim \mathrm{Normal}(0, ~12.68)\\
...
mpg_priors <- prior(student_t(10, 19.2, 3), class = Intercept) +
  ...
  prior(normal(0, 19.02312), class = b, coef = log_hp) +
