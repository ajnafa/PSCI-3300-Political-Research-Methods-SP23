...
-   Easiest way to avoid headaches involving file paths is for you to download
    the [course's repository from
    github](https://github.com/ajnafa/psci-3300-political-science-research)
...
-   All text and images in this course are made available for public
    non-commercial use under a [Creative Commons Attribution-NonCommercial 4.0
    International (CC BY-NC 4.0)
    License](https://creativecommons.org/licenses/by-nc/4.0/).

-   All R, HTML, and CSS code is provided for public use under a [BSD 3-Clause
    License](https://github.com/ajnafa/psci-3300-political-science-research/blob/main/LICENSE).
...
-   The files and code necessary to reproduce the content of this course are or
    ...
    repository](https://github.com/ajnafa/psci-3300-political-science-research)
